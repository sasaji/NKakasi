...
namespace Romanizer
{
    public class Romanizer
    {
        ...
        private readonly LongVowelStyle _longVowelStyle = LongVowelStyle.Omit;
        ...
        private string LongVowel(string source)
        {
            ...
            if (_longVowelStyle == LongVowelStyle.AsIs) return result;
            if (_longVowelStyle == LongVowelStyle.ToOH)
        ...
        public SpellingStyle SpellingStyle { get; } = SpellingStyle.Hepburn;
    }
}
